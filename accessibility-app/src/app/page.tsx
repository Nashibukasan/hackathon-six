      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-soft">
              <div className="w-16 h-16 bg-success-100 rounded-full flex items-center justify-center mb-4 mx-auto">
              ...
              <Link 
                href="/dashboard"
                className="inline-flex items-center px-6 py-3 bg-success-600 text-white font-medium rounded-lg hover:bg-success-700 focus:outline-none focus:ring-2 focus:ring-success-500 focus:ring-offset-2 transition-colors"
              >
                View Dashboard
                <svg className="ml-2 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="text-center">
              <div className="w-12 h-12 bg-warning-100 rounded-full flex items-center justify-center mb-3 mx-auto">
            ...
            <div className="text-center">
              <div className="w-12 h-12 bg-primary-100 rounded-full flex items-center justify-center mb-3 mx-auto">
            ...
            <div className="text-center">
              <div className="w-12 h-12 bg-success-100 rounded-full flex items-center justify-center mb-3 mx-auto">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-soft">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link 
                href="/register"
                className="inline-flex items-center justify-center px-6 py-3 bg-success-600 text-white font-medium rounded-lg hover:bg-success-700 focus:outline-none focus:ring-2 focus:ring-success-500 focus:ring-offset-2 transition-colors"
              >
                Create Account
              </Link>
              <Link 
